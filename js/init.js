...
$(document).ready(async function() {
    ...
    var priceInfo = await pcsRouter.methods.getAmountsOut("100000", ["0xfef0c1670cb569008bb3d070918922dbb4f92de4", "0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c", "0xe9e7cea3dedca5984780bafc599bd69add087d56"]).call();
    ...
    $("#burned").text(Math.round(burned) + " ES2");
    $("#holders").text(supply.toFixed(0) + " ES2");
